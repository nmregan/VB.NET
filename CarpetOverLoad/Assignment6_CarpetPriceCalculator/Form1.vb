...
Public Class Form1
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ' Declare Variables
        Const dblDiscountA As Double = 0.2
        Const dblDiscountB As Double = 0.3
        Const dblDiscountC As Double = 0.4
    ...
    Function Validation() As Boolean
        ...
        ' Checks to see that discount code textbox is empty, if so, 
        ' a message box pops up and the user is unable to proceed
        If txtDiscountCode.Text = String.Empty Then
            MessageBox.Show("Please enter a Discount Code.")
            txtDiscountCode.BackColor = Color.Yellow
